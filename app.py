...
if __name__ == '__main__':
    app.run(debug=True, ssl_context=('TuneScape.crt', 'TuneScape.key'), host='192.168.0.182', port=5000) # Change host IP to private IP of machine running (This is to enable other devices on the same network to connect)
